...
<body>
	<h1 style="color:white;">🧙AI-powered interactive text based story generator game⚔️</h1>
	<div class="container">
	...
	<form action="/message_response" method="get" class="input-form" name="fn">
		<input type="hidden" name="sessionId" value="${sessionId}" />
		<input type="text" id="userInput" name="query" placeholder="Enter Your First/next action">
